...
import { PagoResumeLong } from '../../../../component/ResumeWidget/CardWidget';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../../../../context/useAuth';
import { BACKEND_URL } from '../../../../utils/api/config';

function PagoResumeLongComponent() {
      ...
      {pagos.length === 0 ? (
        ...
        <div key={pago.id} style={{ marginBottom: '1em' }} onClick={() => handleCardClick(pago.id)}>
          <PagoResumeLong
            ...
            telefono={pago.cliente.telefonoUno}
            fechaPago={pago.fechaPago}
            fechaProxPago={pago.fechaProxPago}
          />
        </div>
      ))
      )}
...
export default PagoResumeLongComponent;
